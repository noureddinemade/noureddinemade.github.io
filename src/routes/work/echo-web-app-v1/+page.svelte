...
<Block props={{ "class":"general" }}>
    ...
    <div class="columns -two spacing -gap-lg -m-t-lg -m-b-lg">
        <Image src="work/echo/web-v1/001-draft-layers.png" alt="<REPLACE>" parent={{}} props={{ "class":"border -r-sm -s-base colour -bg -bg-light-dark spacing" }}/>
        <Image src="work/echo/web-v1/002-draft-wireframe-1.png" alt="<REPLACE>" parent={{}} props={{ "class":"border -r-sm -s-base colour -bg -bg-light-dark spacing" }}/>
        <Image src="work/echo/web-v1/002-draft-wireframe-2.png" alt="<REPLACE>" parent={{}} props={{ "class":"border -r-sm -s-base colour -bg -bg-light-dark spacing" }}/>
        <Image src="work/echo/web-v1/002-draft-wireframe-3.png" alt="<REPLACE>" parent={{}} props={{ "class":"border -r-sm -s-base colour -bg -bg-light-dark spacing" }}/>
    </div>
    <p class="text -lg">
...
<Block props={{ "class":"general" }}>
    ...
    <div class="img-slider border -r-sm -s-base colour -bg -bg-accent-a-light spacing -p-sm -m-t-lg -m-b-lg" data-draggable data-cursor="🤚🏽">
        <Image src="work/echo/web-v1/003-final-desktop-1.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-2.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-3.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-4.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-5.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-6.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-7.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-8.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-9.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-10.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-11.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-1.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-2.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-3.png" alt="<REPLACE>"/>
        <Image src="work/echo/web-v1/003-final-desktop-4.png" alt="<REPLACE>"/>
